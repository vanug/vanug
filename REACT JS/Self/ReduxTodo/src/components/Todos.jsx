        ...
        {todos.map((todo) => (
          ...
          >
            ...
            <input
              ...
              />
              <button
                onClick={() => dispatch(updateTodo({ id: todo.id, text: newinput }))}
                className="text-white bg-blue-500 border-0 py-1 px-4 
                focus:outline-none hover:bg-blue-600 rounded text-base"
              >
                <svg
              ...
              <button
                ...
                focus:outline-none hover:bg-red-600 rounded text-base"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
